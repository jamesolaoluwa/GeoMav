...
Exception for reference-matched implementations:
If the user provides a visual reference and explicitly wants the layout and aesthetic closely matched, prioritize the reference over general anti-pattern rules. Recreate the composition, spacing, color relationships, softness, rounded geometry, and visual hierarchy faithfully, while still keeping the code production-grade and non-generic.

For premium fintech, stablecoin, or modern product landing pages, restrained use of lavender, periwinkle, soft violet, misty gray-blue, and deep plum is acceptable when clearly grounded in a supplied reference and paired with strong typography, refined spacing, and realistic depth.
