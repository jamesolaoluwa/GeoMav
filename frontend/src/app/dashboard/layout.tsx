...
const SIDEBAR_NAV = [
  ...
  },
  {
    group: "Monitor",
    items: [
      { href: "/dashboard/hallucinations", label: "Hallucinations", icon: AlertTriangleIcon },
  ...
  },
  {
    group: "Action",
    items: [
      { href: "/dashboard/opportunities", label: "Opportunities", icon: LightbulbIcon },
...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-60 transform bg-[#1a1225] transition-transform duration-200 ease-in-out lg:translate-x-0 ${
        ...
        <div className="flex h-full flex-col">
          <div className="flex h-16 items-center justify-between border-b border-white/10 px-4">
            <div className="flex items-center gap-2">
              <Link href="/" className="text-lg font-semibold text-white hover:text-gray-200 transition-colors">
                GeoMav
              </Link>
              <Link
                href="/"
          ...
          <div className="border-t border-white/10 p-4">
            ...
            <button
              ...
              disabled={loggingOut}
              className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-gray-300 transition-colors hover:bg-white/5 hover:text-white disabled:opacity-50"
            >
              <svg className="h-5 w-5 shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
